...
private static final Logger logger = LoggerFactory.getLogger(WaterWheel.class);
	...
	public WaterWheel(Queue<Water> waterFlow) {
		setName("Thread.WaterWheel"+Thread.currentThread().getId());
